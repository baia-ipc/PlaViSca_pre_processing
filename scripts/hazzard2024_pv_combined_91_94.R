...
study_num <- "39223117"
#samples <- c(paste0("SRR27021", 959:994))
samples <- c(paste0("SRR27021", 991:994))
...
run_id <- rep(paste0("SRR27021", 991:994), length(all_pv))
...
day_post_infection <- c(17, 14, 17, 17)
...
# Save Seurat object
saveRDS(pv.combined.all, file = "hazzard2024_pv_combined_91_94.rds")
# Remove all object
rm(list = ls())
gc()
